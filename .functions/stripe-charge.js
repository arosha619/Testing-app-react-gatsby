...
const stripe = __webpack_require__(16)('YOUR_STRIPE_SECRET_KEY');
...
const _Error = __webpack_require__(3);
const {
  StripeAPIError,
...
const {HttpClient} = __webpack_require__(4);
...
function getNodeCryptoProvider() {
  if (!webhooksNodeCryptoProviderInstance) {
    const NodeCryptoProvider = __webpack_require__(15);
...
const crypto = __webpack_require__(12);
const CryptoProvider = __webpack_require__(8);
/**
...
const {HttpClient, HttpClientResponse} = __webpack_require__(4);
...
const utils = __webpack_require__(2);
const makeRequest = __webpack_require__(13);
...
const _HttpClient = __webpack_require__(4);
